...
function scene:create( event )
  ...
  print ("elegido"..  myData.elegida)
  print ("la correcta es " .. myData.correcta )
  if myData.correcta == 1 then
...
function cerrar()  
  composer.gotoScene( "preguntaCorrecta", "slideRight", 500 ) 
end
